...
if($filename == ""){
	...
	mysqli_query($koneksi, "update arsip set arsip_waktu_upload='$waktu', arsip_kode='$kode', arsip_nama='$nama', arsip_kategori='$kategori', arsip_keterangan='$keterangan' where arsip_id='$id'")or die(mysqli_error($koneksi));
