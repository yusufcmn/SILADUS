...
<head>
    ...
    <title>Login Admin | Sistem Informasi Pengolahan Data Industri Kota Surabaya</title>
    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                ...
                <h4>Sistem Informasi Pengolahan Data Industri Kota Surabaya</h4>
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. All rights reserved. Creator  mas yusuf DISPENAKER</p>
            </div>
        </div>   
    </div>
